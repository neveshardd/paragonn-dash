...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { data, form } = $$props;
		let imagem = data.produto.imagem ?? "";
		let $$settled = true;
		let $$inner_renderer;
		function $$render_inner($$renderer) {
			...
			$$renderer.push(`</textarea></div> <div class="field">`);
