...
import { t as BlogImagemField } from "../../../../chunks/BlogImagemField.js";
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		function $$render_inner($$renderer) {
			...
			$$renderer.push(`<!----> <div class="field"><label for="descricao">Descrição *</label> <textarea id="descricao" name="descricao" rows="6" placeholder="Conteúdo da postagem..." required="" style="min-height:120px">`);
